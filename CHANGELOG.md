...
- 2.7.46 (20240502) 
  ...
  - MDegrain1-6 8 bit: Add avx2 code path (already was in code but disabled, now go live)
  - MDegrainN 10-16 bits: add SSE4.1 code path (was: C only)
  - VerticalBicubic interpolation SSE4.1 version besides SSE2
  ...
  - internals: MDegrain: for block size of 4, read exactly 4 bytes instead of 8. (in extreme cases it would read past a valid memory area)
